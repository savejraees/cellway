...
public class ProductCateogoryAdapter extends RecyclerView.Adapter<ProductCateogoryAdapter.ProductViewHolder> {

    Context context;
    ArrayList<ProductCategoryDatumModel> arrProduct;
    String type;
    String ProductId;
    SessonManager sessonManager;
    public ProductCateogoryAdapter(Context context, ArrayList<ProductCategoryDatumModel> arrProduct, String type,String ProductId) {
    ...
    @NonNull
    @Override
    public ProductCateogoryAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        view = layoutInflater.inflate(R.layout.row_your_mobile_dest, parent, false);
        return new ProductCateogoryAdapter.ProductViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull ProductCateogoryAdapter.ProductViewHolder holder, int position) {
        final ProductCategoryDatumModel model = arrProduct.get(position);
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            tv_CategoryType.setVisibility(View.GONE);
