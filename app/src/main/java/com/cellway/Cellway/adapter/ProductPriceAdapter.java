...
public class ProductPriceAdapter extends RecyclerView.Adapter<ProductPriceAdapter.ProductViewHolder> {
    ...
    Context context;
    ArrayList<ProductPriceDatumModel> arrProduct;
    String type;
    String p1,p2;
    SessonManager sessonManager;
    public ProductPriceAdapter(Context context, ArrayList<ProductPriceDatumModel> arrProduct, String type, String p1,String p2) {
    ...
    public void onBindViewHolder(@NonNull ProductPriceAdapter.ProductViewHolder holder, int position) {
        final ProductPriceDatumModel model = arrProduct.get(position);
        ...
        holder.linearMobileDest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sessonManager.setPrice1(p1);
                sessonManager.setPrice2(p2);
