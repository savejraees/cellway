...
public class ProductBrandAdapter extends RecyclerView.Adapter<ProductBrandAdapter.ProductViewHolder> {

    Context context;
    ArrayList<ProductBrandDatumModel> arrProduct;
    String type;
    String ProductId;
    SessonManager sessonManager;
    public ProductBrandAdapter(Context context, ArrayList<ProductBrandDatumModel> arrProduct, String type, String ProductId) {
    ...
    @NonNull
    @Override
    public ProductBrandAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        view = layoutInflater.inflate(R.layout.row_your_mobile_dest, parent, false);
        return new ProductBrandAdapter.ProductViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull ProductBrandAdapter.ProductViewHolder holder, int position) {
        final ProductBrandDatumModel model = arrProduct.get(position);
