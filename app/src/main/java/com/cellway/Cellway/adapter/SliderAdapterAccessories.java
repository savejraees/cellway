...
public class SliderAdapterAccessories extends PagerAdapter {
    private ArrayList<CatgoryBannerModel> images;
    private LayoutInflater inflater;
    private Context context;

    public SliderAdapterAccessories(Context context, ArrayList<CatgoryBannerModel> images) {
